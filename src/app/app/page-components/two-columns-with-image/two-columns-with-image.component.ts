...
@Component({
  selector: "ngx-two-columns-with-image-page-component",
  templateUrl: "./two-columns-with-image.component.html",
  styleUrls: ["./two-columns-with-image.component.scss"],
})
export class TwoColumnsWithImagePageComponentComponent implements OnInit {
